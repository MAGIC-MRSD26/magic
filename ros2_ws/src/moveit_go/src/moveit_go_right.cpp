...
int main(int argc, char * argv[]){
  ...
  // Create a ROS logger
  auto const logger = rclcpp::get_logger("moveit_go_right");
  ...
  moveit::planning_interface::MoveGroupInterface MoveGroupInterface(node, "right_arm");

  // Construct and initialize MoveItVisualTools
  auto moveit_visual_tools = moveit_visual_tools::MoveItVisualTools{
    node, "right_base_link", rviz_visual_tools::RVIZ_MARKER_TOPIC,
  ...
  auto const draw_trajectory_tool_path =
      ...
      jmg = MoveGroupInterface.getRobotModel()->getJointModelGroup(
          "right_arm")](auto const trajectory) {
